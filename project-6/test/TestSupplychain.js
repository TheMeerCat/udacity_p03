...
contract('SupplyChain', function (accounts) {
    ...
    it("Testing smart contract function buyItem() that allows a distributor to buy coffee", async () => {
        const supplyChain = await SupplyChain.deployed()
        const farmerBalance1 = await web3.eth.getBalance(originFarmerID);
        ...
        const farmerBalance2 = await web3.eth.getBalance(originFarmerID);
        ...
        assert.equal(resultBufferTwo[4], productPrice, 'Error: Missing or Invalid item Price')
        assert.equal(Number(farmerBalance1) + Number(productPrice), Number(farmerBalance2), 'Error: Transaction was not successful')
    })
